...
export default function FiltersDropdown({
  ...
  return (
    <div ref={filtersRef} className="relative">
      ...
      {showFilters && (
        <div className="absolute mt-2 right-0 w-80 max-h-[70vh] overflow-y-auto bg-white dark:bg-surface-dark border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-4 z-50">
          <div className="mb-3">
